...
const builtinExtensions = {
    ...
    listblocks: () => require('../extensions/scratch3_listblocks'),
    tangoblocks: () => require('../extensions/scratch3_tangoblocks'),
    hyoukablocks: () => require('../extensions/scratch3_hyoukablocks')
};
